...
export default function Home() {
  ...
  // Listen untuk event confirmReset dari komponen Recorder
  useEffect(() => {
  ...
  <div className="bg-blue-400 border-4 border-blue-500 rounded-2xl shadow-indigo-400/50 shadow-2xl p-10 w-full max-w-lg flex flex-col items-center transition hover:scale-105 relative">
            ...
            <div className="flex flex-col items-center w-full mb-6">
              <div className="flex w-full mb-2 items-center justify-center" style={{gap: '10px'}}>
                <button
                  ...
                  className={`min-w-[160px] px-12 py-8 rounded-full bg-gradient-to-br from-indigo-500 to-blue-500 border-indigo-300 hover:from-indigo-600 hover:to-blue-600 text-white text-2xl font-extrabold shadow-2xl border-4 transform transition-all duration-200 flex items-center gap-4 justify-center whitespace-nowrap relative overflow-hidden ${currentIndex === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:scale-105'}`}
                ...
                <button onClick={handleNext} className="min-w-[160px] px-12 py-8 rounded-full bg-gradient-to-br from-indigo-500 to-blue-500 border-indigo-300 hover:from-indigo-600 hover:to-blue-600 text-white text-2xl font-extrabold shadow-2xl border-4 hover:scale-105 transform transition-all duration-200 flex items-center gap-4 justify-center whitespace-nowrap relative overflow-hidden">
                  <span className='absolute left-0 top-0 w-full h-2/5 bg-white/30 rounded-t-full pointer-events-none' style={{filter:'blur(2px)'}}></span>
        ...
        {/* Komponen Recorder */}
        <Recorder currentWord={started ? namaBarang[currentIndex] : ""} />
